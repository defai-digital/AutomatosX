...
import { AgentProfileSchema, AgentRunOptionsSchema, AgentResultSchema, AgentWorkflowStepSchema, validateAgentProfile, safeValidateAgentProfile, AgentErrorCode, 
// Agent Selection Schemas (INV-AGT-SEL)
AgentRecommendRequestSchema, AgentRecommendResultSchema, AgentMatchSchema, AgentCapabilitiesRequestSchema, AgentCapabilitiesResultSchema, } from '@defai.digital/contracts';
describe('Agent Contract', () => {
    ...
    describe('Validation Functions', () => {
        it('validateAgentProfile should throw on invalid input', () => {
            expect(() => validateAgentProfile({ agentId: '' })).toThrow();
        });
    ...
    describe('Error Codes', () => {
        it('should have all required error codes', () => {
            ...
            expect(AgentErrorCode.AGENT_DELEGATION_DEPTH_EXCEEDED).toBe('AGENT_DELEGATION_DEPTH_EXCEEDED');
...
describe('INV-AGT: Agent Registry Invariants', () => {
    ...
    describe('INV-AGT-005: Capability Matching', () => {
        ...
        it('should filter agents by required capability', () => {
            ...
            const reviewCapable = agents.filter((a) => a.capabilities?.includes('review'));
        ...
        it('should match agents with multiple required capabilities', () => {
            ...
            const matching = agents.filter((a) => requiredCaps.every((cap) => a.capabilities?.includes(cap)));
