...
import { z } from 'zod';
import { BaseCommandSchema, AgentNameSchema, TaskDescriptionSchema, ProviderSchema, TimeoutSchema, } from './common.js';
/**
 ...
 */
export function validateRunCommand(input) {
    try {
 ...
 */
export function safeValidateRunCommand(input) {
    const result = RunCommandSchema.safeParse(input);
    return result.success
        ? { success: true, data: result.data }
        : { success: false, error: result.error };
}
//# sourceMappingURL=RunCommandSchema.js.map