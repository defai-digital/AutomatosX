...
const createWorkflowDef = (id, tasks, maxRetries = 3, timeout, allowParallel = true) => {
    return WorkflowOrchestrator.createWorkflowDefinition(id, `Workflow ${id}`, `Description for workflow ${id}`, tasks, maxRetries, timeout, allowParallel);
};
// ============================================================================
...
//# sourceMappingURL=WorkflowOrchestrator.test.js.map