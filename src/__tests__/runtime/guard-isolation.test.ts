...
// Test data factories
const createTestContext = (state: string, event: string, metadata?: any) => {
...
describe('Isolated Guard Executor', () => {
  ...
  it('executes batch of guards with early termination on failure', () => {
    ...
    const guard1 = (ctx: any) => 'Pass'
    const guard2 = (ctx: any) => ({ TAG: 'Fail', _0: 'Second guard failed' })
    const guard3 = (ctx: any) => 'Pass' // Should not execute due to early termination
  ...
  it('combines verdicts with first failure winning', () => {
    ...
    const guard1 = (ctx: any) => 'Pass'
    const guard2 = (ctx: any) => ({ TAG: 'Fail', _0: 'Critical failure' })
...
describe('Audit Log - Immutable Logging', () => {
  ...
  it('verifies audit log integrity with valid signatures', () => {
    ...
    const guard1 = (ctx: any) => 'Pass'
    const guard2 = (ctx: any) => ({ TAG: 'Defer', _0: 'Async check pending' })
...
describe('Threat T2 Mitigation - Integration Tests', () => {
  ...
  it('provides complete audit trail for guard evaluations', () => {
    ...
    const guards: Array<[(ctx: any) => any, string]> = [
      ...
      [(ctx: any) => 'Pass', 'policy-guard'],
      [(ctx: any) => ({ TAG: 'Defer', _0: 'Dependency check pending' }), 'dependency-guard']
    ]
