...
export class TemplateRenderer {
     ...
     */
    async render(structure, workflow, options) {
        ...
        for (const fileTemplate of structure.fileTemplates) {
            try {
                ...
                throw new Error(`Failed to render template '${fileTemplate.template}' for file '${fileTemplate.path}': ${error.message}`);
            }
        }
        return files;
    }
