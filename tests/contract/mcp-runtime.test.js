...
import { 
// Cache schemas
MCPCacheEntrySchema, MCPCacheConfigSchema, MCPCacheStatsSchema, 
// Timeout schemas
MCPTimeoutConfigSchema, TimeoutResultSchema, TOOL_CATEGORIES, getToolTimeout, 
// Response schemas
MCPErrorCodeSchema, MCPStructuredErrorSchema, MCPPaginationSchema, MCPResponseLimitsSchema, isRetryableError, 
// Limits schemas
MCPRequestLimitsSchema, ValidationErrorSchema, ValidationResultSchema, TOOL_ARRAY_FIELDS, getArrayLimit, } from '@defai.digital/contracts';
    ...
    describe('Cache Contracts', () => {
        ...
        describe('MCPCacheConfigSchema', () => {
            ...
            it('should reject invalid eviction policy', () => {
                expect(() => MCPCacheConfigSchema.parse({ evictionPolicy: 'invalid' })).toThrow();
            });
            it('should reject high water mark > 1', () => {
                expect(() => MCPCacheConfigSchema.parse({ highWaterMark: 1.5 })).toThrow();
            });
        });
