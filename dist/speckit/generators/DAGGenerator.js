...
export class DAGGenerator {
     ...
     */
    generateASCII(workflow, graph, criticalPath, highlight, nodeLabels) {
        const lines = [];
     ...
     */
    generateDOT(workflow, graph, criticalPath, highlight, orientation, nodeLabels, includeDetails) {
        const lines = [];
        const criticalSet = new Set(criticalPath);
        // Graph header
     ...
     */
    generateMermaid(workflow, graph, criticalPath, highlight, orientation, nodeLabels) {
        const lines = [];
        const criticalSet = new Set(criticalPath);
        // Graph header
     ...
     * Write DAG to file
     */
    async writeDAG(result, workflow, outputPath) {
...
//# sourceMappingURL=DAGGenerator.js.map