...
import { SessionSchema, SessionTaskSchema, SessionParticipantSchema, SessionStatusSchema, TaskStatusSchema, CreateSessionInputSchema, JoinSessionInputSchema, StartTaskInputSchema, validateSession, safeValidateSession, isValidSessionTransition, isValidTaskTransition, SESSION_TRANSITIONS, TASK_TRANSITIONS, SessionErrorCode, } from '@defai.digital/contracts';
describe('Session Contract', () => {
    ...
    describe('Validation Functions', () => {
        it('validateSession should throw on invalid input', () => {
            expect(() => validateSession({ sessionId: 'invalid' })).toThrow();
        });
    ...
    describe('Error Codes', () => {
        it('should have all required error codes', () => {
            ...
            expect(SessionErrorCode.SESSION_ALREADY_COMPLETED).toBe('SESSION_ALREADY_COMPLETED');
            expect(SessionErrorCode.SESSION_INVALID_TRANSITION).toBe('SESSION_INVALID_TRANSITION');
            expect(SessionErrorCode.SESSION_AGENT_NOT_PARTICIPANT).toBe('SESSION_AGENT_NOT_PARTICIPANT');
            expect(SessionErrorCode.SESSION_TASK_NOT_FOUND).toBe('SESSION_TASK_NOT_FOUND');
        });
    });
    /**
     * Invariant Tests
