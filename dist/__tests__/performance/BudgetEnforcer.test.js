...
import { BudgetEnforcer, BudgetExceededError, createBudgetEnforcer, getGlobalEnforcer, resetGlobalEnforcer, } from '../../performance/BudgetEnforcer.js';
describe('BudgetEnforcer', () => {
    ...
    describe('withBudget Helper', () => {
        ...
        it('should throw on budget violation', async () => {
            enforcer.updateBudget({ maxDuration: 10 });
            await expect(enforcer.withBudget('op1', async () => {
                await new Promise((resolve) => setTimeout(resolve, 100));
                return 'done';
...
//# sourceMappingURL=BudgetEnforcer.test.js.map