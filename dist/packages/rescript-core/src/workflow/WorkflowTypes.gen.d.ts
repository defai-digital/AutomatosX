export type StepType_t = "AgentTask" | "HttpRequest" | "FileOperation" | "DatabaseQuery" | "SemanticSearch" | "Transform" | "Conditional" | "Parallel" | "Sequential";
...
export type StepConfig_parallel = {
    readonly steps: string[];
    readonly maxConcurrency: (undefined | number);
};
export type StepConfig_sequential = {
    readonly steps: string[];
};
export type StepConfig_t = {
    TAG: "AgentTask";
    _0: StepConfig_agentTask;
} | {
    TAG: "HttpRequest";
    _0: StepConfig_httpRequest;
} | {
    TAG: "FileOperation";
    _0: StepConfig_fileOperation;
} | {
    TAG: "DatabaseQuery";
    _0: StepConfig_databaseQuery;
} | {
    TAG: "SemanticSearch";
    _0: StepConfig_semanticSearch;
} | {
    TAG: "Transform";
    _0: StepConfig_transform;
} | {
    TAG: "Conditional";
    _0: StepConfig_conditional;
} | {
    TAG: "Parallel";
    _0: StepConfig_parallel;
} | {
    TAG: "Sequential";
    _0: StepConfig_sequential;
};
...
export type VariableDefinition_varType = "String" | "Number" | "Boolean" | "Object" | "Array";
...
export type DependencyGraph_t = {
    readonly nodes: DependencyGraph_node[];
    readonly levels: Array<string[]>;
};
export type ExecutionResult_status = "Success" | "Failure" | "Skipped" | "Cancelled";
...
export declare const makeStepDefinition: (id: string, name: string, stepType: StepType_t, config: StepConfig_t, dependsOn: (undefined | string[]), timeout: (undefined | number), retries: (undefined | number), continueOnError: (undefined | boolean), _9: void) => StepDefinition_t;
export declare const makeWorkflowMetadata: (name: string, description: (undefined | string), version: (undefined | string), author: (undefined | string), tags: (undefined | string[]), _6: void) => WorkflowMetadata_t;
export declare const makeWorkflowDefinition: (id: string, metadata: WorkflowMetadata_t, variables: (undefined | VariableDefinition_t[]), steps: StepDefinition_t[], onSuccess: (undefined | string[]), onFailure: (undefined | string[]), onCancel: (undefined | string[]), _8: void) => WorkflowDefinition_t;
export declare const makeDependencyGraph: (_1: StepDefinition_t[]) => DependencyGraph_t;
export declare const makeExecutionResult: (stepId: string, startedAt: number) => ExecutionResult_t;
//# sourceMappingURL=WorkflowTypes.gen.d.ts.map