...
export class QualityAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in quality assurance, testing strategies, code reviews, and test automation. Specializes in ensuring code quality and test coverage.',
            capabilities: [
                {
                    name: 'Test Strategy',
    ...
    async executeTask(task, context, options) {
        ...
        try {
            // Find code to test
            const codeToTest = await context.codeIntelligence.searchCode(task.description.replace(/test|spec/gi, ''));
    ...
    buildTestingPrompt(task, context, codeContext, pastTests) {
...
//# sourceMappingURL=QualityAgent.js.map