...
export class DevOpsAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in DevOps, CI/CD, infrastructure automation, containerization, and cloud platforms. Specializes in building scalable, reliable deployment pipelines.',
            capabilities: [
                {
    ...
    async executeTask(task, context, options) {
        ...
        try {
            ...
            const infraCode = await context.codeIntelligence.searchCode('docker terraform github actions');
    ...
    buildDevOpsPrompt(task, context, infraContext, pastDeployments) {
