 ...
 */
export function validateMemorySearch(input: unknown): MemorySearch {
  try {
 ...
 */
export function safeValidateMemorySearch(
  input: unknown
): { success: true; data: MemorySearch } | { success: false; error: z.ZodError } {
