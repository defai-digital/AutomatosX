 ...
 */
export function validateConfigShow(input: unknown): ConfigShow {
  try {
 ...
 */
export function safeValidateConfigShow(
  input: unknown
): { success: true; data: ConfigShow } | { success: false; error: z.ZodError } {
