 ...
 */
export function validatePaymentIntent(data: unknown): PaymentIntent {
 ...
 */
export function safeValidatePaymentIntent(
  data: unknown
): { success: true; data: PaymentIntent } | { success: false; error: z.ZodError } {
