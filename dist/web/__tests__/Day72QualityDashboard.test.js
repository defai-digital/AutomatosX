...
vi.mock('recharts', () => ({
    ...
    LabelList: () => _jsx("div", { "data-testid": "label-list" }),
}));
// Test data
const mockMetrics = {
    fileCount: 100,
...
describe('QualityOverviewCards', () => {
    it('should render all 4 metric cards', () => {
        render(_jsx(QualityOverviewCards, { metrics: mockMetrics }));
    ...
    it('should use responsive grid layout', () => {
        const { container } = render(_jsx(QualityOverviewCards, { metrics: mockMetrics }));
...
describe('ComplexityChart', () => {
    it('should render BarChart component', () => {
        render(_jsx(ComplexityChart, { fileReports: mockFileReports }));
    ...
    it('should limit files to maxFiles prop', () => {
        render(_jsx(ComplexityChart, { fileReports: mockFileReports, maxFiles: 2 }));
        expect(screen.getByText(/Top 2 most complex files/)).toBeInTheDocument();
    });
    it('should sort files by complexity descending', () => {
        const { container } = render(_jsx(ComplexityChart, { fileReports: mockFileReports }));
    ...
    it('should show "No data available" when empty', () => {
        render(_jsx(ComplexityChart, { fileReports: [] }));
...
describe('CodeSmellsChart', () => {
    it('should render PieChart component', () => {
        render(_jsx(CodeSmellsChart, { fileReports: mockFileReports }));
    ...
    it('should categorize high complexity smells', () => {
        ...
        render(_jsx(CodeSmellsChart, { fileReports: reports }));
    ...
    it('should show "No data available" when empty', () => {
        render(_jsx(CodeSmellsChart, { fileReports: [] }));
        expect(screen.getByText('No data available')).toBeInTheDocument();
    });
    it('should use responsive container', () => {
        render(_jsx(CodeSmellsChart, { fileReports: mockFileReports }));
...
describe('GradeDistributionChart', () => {
    it('should render BarChart component', () => {
        render(_jsx(GradeDistributionChart, { metrics: mockMetrics }));
        expect(screen.getByTestId('bar-chart')).toBeInTheDocument();
    });
    it('should display chart title', () => {
        render(_jsx(GradeDistributionChart, { metrics: mockMetrics }));
    ...
    it('should show "No data available" when fileCount is 0', () => {
        ...
        render(_jsx(GradeDistributionChart, { metrics: emptyMetrics }));
        expect(screen.getByText('No data available')).toBeInTheDocument();
    });
    it('should use responsive container', () => {
        render(_jsx(GradeDistributionChart, { metrics: mockMetrics }));
...
describe('FileQualityTable', () => {
    it('should render table with all columns', () => {
        render(_jsx(FileQualityTable, { fileReports: mockFileReports }));
    ...
    it('should call onFileSelect when row clicked', () => {
        ...
        render(_jsx(FileQualityTable, { fileReports: mockFileReports, onFileSelect: onFileSelect }));
    ...
    it('should show "No files found" when empty', () => {
        render(_jsx(FileQualityTable, { fileReports: [] }));
...
describe('QualityFilters', () => {
    ...
    it('should render all filter controls', () => {
        ...
        render(_jsx(QualityFiltersComponent, { filters: defaultFilters, onFiltersChange: onChange }));
    ...
    it('should show active filters count', () => {
        ...
        const onChange = vi.fn();
        render(_jsx(QualityFiltersComponent, { filters: activeFilters, onFiltersChange: onChange }));
...
describe('QualityDashboard Integration', () => {
    ...
    it('should render dashboard with all sections', async () => {
        ...
        render(_jsx(Provider, { store: store, children: _jsx(QualityDashboard, {}) }));
        await waitFor(() => {
...
//# sourceMappingURL=Day72QualityDashboard.test.js.map