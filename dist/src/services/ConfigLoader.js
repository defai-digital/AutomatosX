...
import os from 'os';
import { AutomatosXConfigSchema, PartialConfigSchema, ConfigSource, } from '../types/Config.js';
import { z } from 'zod';
/**
...
export class ConfigLoader {
    ...
    constructor() {
        ...
        this.globalConfigPath = path.join(os.homedir(), '.automatosx', 'config.json');
    }
    /**
     ...
     */
    markConfigFields(sources, config, source) {
