...
describe('SpecGenerator', () => {
  ...
  beforeEach(() => {
    ...
    mockProviderRouter = {
      route: vi.fn(),
    } as unknown as ProviderRouterV2;
...
steps:
  ...
  - id: "step-2"
    ...
    timeout: 15000`;
      ...
      (mockProviderRouter.route as ReturnType<typeof vi.fn>).mockResolvedValue({
        content: mockYAML,
        provider: 'claude',
      ...
      const result = await generator.generateSpec(
        'Check code quality for my TypeScript project',
...
steps:
  - id: "step-1"
    ...
    timeout: 20000`;
      ...
      const routeCall = (mockProviderRouter.route as ReturnType<typeof vi.fn>).mock.calls[0][0];
    ...
    it('should throw error for empty description', async () => {
      await expect(generator.generateSpec('')).rejects.toThrow(
    ...
    it('should throw error for invalid YAML', async () => {
      ...
      await expect(
        generator.generateSpec('Invalid workflow', { outputPath: testOutputDir })
...
steps:
  - id: "step-1"
    ...
    action: "test"`;
      ...
      await expect(
        generator.generateSpec('Create workflow', { outputPath: testOutputDir })
      ).rejects.toThrow();
    });
