...
export class ArchitectAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in system architecture, design patterns, ADRs, and technology stack decisions. Specializes in designing scalable, maintainable systems.',
            capabilities: [
                {
                    name: 'System Design',
    ...
    async executeTask(task, context, options) {
        ...
        try {
            ...
            const existingArch = await context.codeIntelligence.searchCode('architecture design pattern');
    ...
    buildArchitecturePrompt(task, context, existingArch, pastDecisions) {
    ...
    parseArchitectureArtifacts(response) {
        const artifacts = [];
