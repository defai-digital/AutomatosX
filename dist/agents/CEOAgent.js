...
export class CEOAgent extends AgentBase {
    ...
    buildCEOPrompt(task, context, codeContext, pastSolutions) {
    ...
    parseCEOArtifacts(response) {
        ...
        while ((match = codeBlockRegex.exec(response)) !== null) {
            ...
            if (language === 'markdown' || language === 'md') {
                if (content.includes('# Business Strategy') || content.includes('# Strategic Plan'))
                    name = 'business-strategy';
                else if (content.includes('# Vision') || content.includes('# Mission'))
                    name = 'vision-document';
                else if (content.includes('# Market Analysis') || content.includes('# Competitive'))
                    name = 'market-analysis';
                else if (content.includes('# Growth') || content.includes('# Expansion'))
                    name = 'growth-plan';
                else if (content.includes('# OKR') || content.includes('# Objectives'))
                    name = 'okr-document';
            }
