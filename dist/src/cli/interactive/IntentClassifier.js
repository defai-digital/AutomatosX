...
export class IntentClassifier {
     ...
     */
    classifyWithPatterns(normalizedInput, originalInput) {
            ...
            for (const regex of regexes) {
                if (regex.test(normalizedInput)) {
                    return {
                        ...
                        confidence: 0.9,
                        method: 'pattern',
                        extractedData: this.extractDataForIntent(intentType, originalInput)
                    };
                }
            }
        }
     ...
     */
    extractDataForIntent(intentType, input) {
        switch (intentType) {
            case 'memory-search':
