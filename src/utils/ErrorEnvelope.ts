...
export class NotFoundError extends Error {
  ...
  constructor(message: string, code: ErrorCode = ErrorCodes.AGENT_NOT_FOUND, suggestions?: string[]) {
    super(message)
...
export class ProviderError extends Error {
  ...
  constructor(message: string, code: ErrorCode = ErrorCodes.PROVIDER_UNAVAILABLE, options?: {
    providerName?: string
    suggestions?: string[]
  }) {
    super(message)
...
export class SystemError extends Error {
  ...
  constructor(message: string, code: ErrorCode = ErrorCodes.INTERNAL_ERROR, suggestions?: string[]) {
    super(message)
 ...
 */
function printErrorEnvelope(envelope: ErrorEnvelope, debug?: boolean): void {
 ...
 */
export function getDefaultSuggestions(code: ErrorCode): string[] {
  switch (code) {
