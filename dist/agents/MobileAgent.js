...
export class MobileAgent extends AgentBase {
    ...
    buildMobilePrompt(task, context, codeContext, pastSolutions) {
    ...
    parseMobileArtifacts(response) {
        ...
        while ((match = codeBlockRegex.exec(response)) !== null) {
            ...
            if (language === 'swift') {
                if (content.includes('SwiftUI') || content.includes('View'))
                    name = 'swiftui-view';
                else if (content.includes('UIKit') || content.includes('UIViewController'))
                    name = 'uikit-controller';
            }
            else if (language === 'kotlin') {
                if (content.includes('@Composable') || content.includes('Compose'))
                    name = 'jetpack-compose';
                else if (content.includes('Activity') || content.includes('Fragment'))
...
//# sourceMappingURL=MobileAgent.js.map