...
import { PluginDebugger, createPluginDebugger, getGlobalDebugger, resetGlobalDebugger, } from '../../plugins/PluginDebugger.js';
describe('PluginDebugger', () => {
    ...
    describe('Breakpoint Management', () => {
        ...
        it('should set conditional breakpoint', () => {
            const breakpoint = dbg.setBreakpoint(sessionId, 'processData', 'count > 10');
    ...
    describe('Logging', () => {
        ...
        it('should log warning message', () => {
            ...
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ level: 'warn' }));
        });
...
//# sourceMappingURL=PluginDebugger.test.js.map