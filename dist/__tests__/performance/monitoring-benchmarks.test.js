...
describe('Monitoring System Performance Benchmarks', () => {
    ...
    describe('Metrics Collection Throughput', () => {
        ...
        it('should efficiently aggregate large metric datasets', () => {
            ...
            const start = Date.now();
            // Perform aggregation
            const aggregation = metrics.getAggregation('aggregate.test', Date.now() - 60000, Date.now());
            const duration = Date.now() - start;
    ...
    describe('Alert Evaluation Performance', () => {
        it('should evaluate alert rules efficiently (100 rules)', () => {
            ...
            for (let i = 0; i < 100; i++) {
                alerting.createRule(`Rule ${i}`, `Description ${i}`, 'test.metric', {
                    operator: 'gt',
                    threshold: 50 + i,
                    windowMs: 60000,
                    aggregation: 'avg',
        ...
        it('should handle cooldown period checks efficiently', () => {
            ...
            const ruleId = alerting.createRule('Cooldown Test', 'Test', 'cooldown.metric', { operator: 'gt', threshold: 10, windowMs: 10000, aggregation: 'sum' }, 'info', { cooldownMs: 1000 });
...
//# sourceMappingURL=monitoring-benchmarks.test.js.map