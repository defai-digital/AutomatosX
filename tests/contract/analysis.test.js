...
import { AnalysisTaskSchema, FindingSeveritySchema, AnalysisSeverityFilterSchema, AnalysisFileSchema, CodeContextSchema, AnalysisFindingSchema, AnalysisRequestSchema, AnalysisResultSchema, validateAnalysisRequest, safeValidateAnalysisRequest, validateAnalysisFinding, safeValidateAnalysisFinding, filterFindingsBySeverity, groupFindingsByCategory, getLanguageFromPath, AnalysisErrorCodes, } from '@defai.digital/contracts';
describe('Analysis Contract', () => {
    ...
    describe('filterFindingsBySeverity', () => {
        ...
        it('should return all findings with "all" filter', () => {
            const result = filterFindingsBySeverity(findings, 'all');
            expect(result).toHaveLength(5);
        });
        it('should filter to critical only', () => {
            const result = filterFindingsBySeverity(findings, 'critical');
    ...
    describe('groupFindingsByCategory', () => {
        ...
        it('should group findings by category', () => {
            const result = groupFindingsByCategory(findings);
