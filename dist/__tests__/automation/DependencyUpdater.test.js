...
import { DependencyUpdater, createDependencyUpdater, getGlobalUpdater, resetGlobalUpdater, UpdateType, } from '../../automation/DependencyUpdater.js';
describe('DependencyUpdater', () => {
    ...
    describe('PR Creation', () => {
        ...
        it('should create PR with multiple updates', async () => {
            ...
            const pr = await updater.createUpdatePR(dependencies.map((dep) => ({ dependency: dep, updateTo: dep.latest })));
...
//# sourceMappingURL=DependencyUpdater.test.js.map