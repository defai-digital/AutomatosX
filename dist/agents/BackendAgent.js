...
export class BackendAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in backend development, API design, databases, authentication, and server-side architecture. Specializes in Node.js, Python, Go, and modern backend frameworks.',
            capabilities: [
                {
                    name: 'API Design',
     ...
     */
    async gatherCodeContext(task, context) {
        try {
     ...
     */
    async gatherMemoryContext(task, context) {
        try {
     ...
     */
    buildEnhancedPrompt(task, context, codeContext, memoryContext) {
