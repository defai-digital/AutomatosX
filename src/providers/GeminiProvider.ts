...
export class GeminiProvider extends BaseProvider {
  ...
  async streamRequest(
    ...
    return this.retryWithBackoff(async () => {
      ...
      let finishReason: 'stop' | 'length' | 'tool_use' | 'error' | undefined
      ...
      try {
        ...
        const streamingResponse = await this.withTimeout(
   ...
   */
  private convertMessages(messages: ProviderRequest['messages']) {
