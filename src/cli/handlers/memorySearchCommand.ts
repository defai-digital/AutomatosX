...
import { MemorySearchSchema, type MemorySearch } from '../schemas/MemorySearchSchema.js'
 ...
 */
async function mockMemorySearch(args: MemorySearch, logger: StreamingLogger): Promise<any[]> {
 ...
 */
function printTableResults(results: any[], verbose: boolean): void {
  console.log('\n┌────────────────────────────────────────────────────────────┐')
 ...
 */
function printTextResults(results: any[], verbose: boolean): void {
