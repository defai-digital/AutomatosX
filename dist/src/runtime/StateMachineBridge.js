...
export class StateMachineBridge {
     ...
     */
    canTransition(event, targetState) {
        // In production, this would call the ReScript function:
    ...
    createMockMachine(taskId, agentName) {
        return {
            currentState: 'idle',
            context: {
                taskId,
 ...
 */
export function createStateMachine(taskId, agentName) {
...
export class WorkflowOrchestrator {
     ...
     * Create new workflow
     */
    createWorkflow(taskId, agentName) {
    ...
    getCompletedWorkflows() {
        return this.getAllWorkflows().filter(machine => machine.getCurrentState() === 'completed');
    }
    /**
     * Get failed workflows
     */
    getFailedWorkflows() {
        return this.getAllWorkflows().filter(machine => machine.getCurrentState() === 'failed');
    }
    /**
     ...
     */
    restoreFromCheckpoints(checkpoints) {
...
//# sourceMappingURL=StateMachineBridge.js.map