...
import { 
// Discussion schemas
DiscussionPatternSchema, ConsensusMethodSchema, ConsensusConfigSchema, DiscussStepConfigSchema, DiscussionProviderResponseSchema, DiscussionRoundSchema, VoteRecordSchema, VotingResultsSchema, ConsensusResultSchema, DiscussionResultSchema, DiscussionRequestSchema, DiscussionErrorCodes, DEFAULT_PROVIDERS, MIN_PROVIDERS, MAX_PROVIDERS, MAX_ROUNDS, DEFAULT_ROUNDS, DEFAULT_PROVIDER_TIMEOUT, 
// Validation functions
validateDiscussStepConfig, safeValidateDiscussStepConfig, validateDiscussionRequest, safeValidateDiscussionRequest, validateDiscussionResult, safeValidateDiscussionResult, 
// Factory functions
...
describe('Discussion Contract - Factory Functions', () => {
    ...
    describe('createFailedDiscussionResult', () => {
        it('should create valid failed result', () => {
            ...
            const result = createFailedDiscussionResult('synthesis', 'Failed topic', DiscussionErrorCodes.ALL_PROVIDERS_FAILED, 'All providers timed out', startedAt);
            expect(result.success).toBe(false);
            expect(result.pattern).toBe('synthesis');
