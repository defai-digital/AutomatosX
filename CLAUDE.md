...
**Note**: For complete user documentation including AI assistant integration, CLI commands, and troubleshooting, see [README.md](README.md) and `AX.md` (generated by `ax init`).
