...
export function DependencyGraphVisualization({ graph, selectedNode, onNodeClick, layoutAlgorithm = 'force', showLabels = true, nodeSize = 8, width = 800, height = 600, }) {
    ...
    if (!graph) {
        return (_jsxs(Paper, { sx: { p: 4, textAlign: 'center', height: height }, children: [_jsx(CircularProgress, {}), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { mt: 2 }, children: "Loading dependency graph..." })] }));
    }
    if (graph.nodes.length === 0) {
        return (_jsx(Paper, { sx: { p: 4, textAlign: 'center', height: height }, children: _jsx(Typography, { variant: "body1", color: "text.secondary", children: "No dependencies found. Try indexing your project first." }) }));
    }
    return (_jsx(Box, { sx: { position: 'relative', width: '100%', height: height }, children: _jsx("svg", { ref: svgRef, width: width, height: height, style: { border: '1px solid #ddd', borderRadius: '4px', background: '#fafafa' } }) }));
}
...
//# sourceMappingURL=DependencyGraphVisualization.js.map