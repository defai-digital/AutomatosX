...
describe('CostEstimator', () => {
    ...
    describe('estimateStepCost', () => {
        it('should estimate cost for claude', () => {
            const cost = estimator.estimateStepCost(testWorkflow.steps[0], 'claude');
        ...
        it('should estimate cost for gemini', () => {
            const cost = estimator.estimateStepCost(testWorkflow.steps[0], 'gemini');
        ...
        it('should apply complexity multiplier', () => {
            const lowCost = estimator.estimateStepCost(testWorkflow.steps[0], 'claude', undefined, 'low');
            const highCost = estimator.estimateStepCost(testWorkflow.steps[0], 'claude', undefined, 'high');
...
describe('PlanGenerator', () => {
    ...
    describe('generatePlan', () => {
        ...
        it('should throw error for cyclic workflow', async () => {
            ...
            await expect(generator.generatePlan(cyclicWorkflow)).rejects.toThrow('circular dependencies');
        });
...
//# sourceMappingURL=Day2Components.test.js.map