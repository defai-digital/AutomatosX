...
import { WorkflowTemplateSchema, WorkflowTemplateStepSchema, WorkflowCategorySchema, WorkflowTemplateExecutionRequestSchema, WorkflowTemplateExecutionResultSchema, WorkflowTemplateRegistryEntrySchema, validateWorkflowTemplate, safeValidateWorkflowTemplate, createWorkflowTemplate, WorkflowTemplateErrorCodes, } from '@defai.digital/contracts';
describe('Workflow Templates Contract', () => {
    ...
    describe('Error Codes', () => {
        it('should have all required error codes', () => {
            ...
            expect(WorkflowTemplateErrorCodes.TEMPLATE_ALREADY_EXISTS).toBe('WORKFLOW_TEMPLATE_ALREADY_EXISTS');
            ...
            expect(WorkflowTemplateErrorCodes.TOOL_NOT_AVAILABLE).toBe('WORKFLOW_TEMPLATE_TOOL_NOT_AVAILABLE');
