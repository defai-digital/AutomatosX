...
describe('ConfigLoader', () => {
    ...
    describe('Project Configuration', () => {
        it('should load project configuration from automatosx.config.json', () => {
            ...
            fs.writeFileSync(path.join(tempDir, 'automatosx.config.json'), JSON.stringify(projectConfig));
        ...
        it('should load project configuration from .automatosx.json', () => {
            ...
            fs.writeFileSync(path.join(tempDir, '.automatosx.json'), JSON.stringify(projectConfig));
            const { config } = configLoader.load(tempDir);
    ...
    describe('Initialization', () => {
        ...
        it('should throw if config already exists', () => {
            fs.writeFileSync(path.join(tempDir, 'automatosx.config.json'), JSON.stringify({ version: '1.0.0' }));
            expect(() => configLoader.initProjectConfig(tempDir)).toThrow('Configuration file already exists');
        });
    });
