...
export class TypeScriptParserService extends BaseLanguageParser {
   ...
   */
  private returnsJSX(node: Parser.SyntaxNode): boolean {
   ...
   */
  private extendsReactComponent(node: Parser.SyntaxNode): boolean {
   ...
   */
  private isArrowFunctionReturningJSX(node: Parser.SyntaxNode): boolean {
