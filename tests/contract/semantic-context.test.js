...
import { SemanticItemSchema, SemanticSearchRequestSchema, SemanticSearchResultSchema, SemanticSearchResponseSchema, SemanticStoreRequestSchema, SemanticStoreResponseSchema, SemanticListRequestSchema, SemanticDeleteRequestSchema, EmbeddingConfigSchema, SemanticContextErrorCodes, validateSemanticItem, validateSemanticSearchRequest, validateSemanticStoreRequest, safeValidateSemanticSearchRequest, createSemanticItem, createDefaultEmbeddingConfig, computeContentHash, } from '@defai.digital/contracts';
describe('Semantic Context Contracts', () => {
    ...
    describe('SemanticSearchRequestSchema', () => {
        ...
        it('should enforce similarity bounds (INV-SEM-003)', () => {
            // Below 0
            expect(SemanticSearchRequestSchema.safeParse({
                query: 'test',
                minSimilarity: -0.1,
            }).success).toBe(false);
            // Above 1
    ...
    describe('SemanticSearchResultSchema', () => {
        ...
        it('should enforce similarity normalization (INV-SEM-003)', () => {
            ...
            expect(SemanticSearchResultSchema.safeParse({
                ...baseResult,
                similarity: 0.5,
            }).success).toBe(true);
            // Invalid: below 0
    ...
    describe('EmbeddingConfigSchema', () => {
        ...
        it('should enforce dimension limits', () => {
            expect(EmbeddingConfigSchema.safeParse({
                dimension: 0,
            }).success).toBe(false);
            expect(EmbeddingConfigSchema.safeParse({
                dimension: 5000,
