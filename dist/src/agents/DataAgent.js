...
export class DataAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in data engineering, ETL pipelines, data modeling, and big data technologies. Specializes in building scalable data processing systems.',
            capabilities: [
                {
                    name: 'ETL Pipelines',
    ...
    async executeTask(task, context, options) {
        ...
        try {
            ...
            const existingPipelines = await context.codeIntelligence.searchCode('pipeline etl data transform');
    ...
    buildDataPrompt(task, context, pipelineContext, pastSolutions) {
