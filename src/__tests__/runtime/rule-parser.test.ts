...
import * as RuleAST from '../../../packages/rescript-core/src/rules/RuleAST.bs.js'
...
describe('RuleParser - Condition Parsing', () => {
  ...
  it('parses ALWAYS and NEVER conditions', () => {
    ...
    const alwaysRule = (alwaysResult as any)._0
    ...
    const neverRule = (neverResult as any)._0
