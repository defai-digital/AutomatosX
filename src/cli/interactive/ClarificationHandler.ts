...
export class ClarificationHandler {
   ...
   */
  private async clarifyIntent(detection: AmbiguityDetection): Promise<ClarificationResult> {
   ...
   */
  private async clarifyVagueQuery(
    query: string,
    detection: AmbiguityDetection
  ): Promise<ClarificationResult> {
   ...
   */
  private async clarifyMissingContext(
    query: string,
    detection: AmbiguityDetection
  ): Promise<ClarificationResult> {
   ...
   */
  private async clarifyConflictingFilters(
    query: string,
    detection: AmbiguityDetection
  ): Promise<ClarificationResult> {
   ...
   */
  private async promptForRephrase(): Promise<ClarificationResult> {
    try {
      const answer = await inquirer.prompt([
        {
          type: 'input',
   ...
   */
  private async promptForRefinedQuery(originalQuery: string): Promise<ClarificationResult> {
    try {
      const answer = await inquirer.prompt([
        {
          type: 'input',
   ...
   */
  private hasMissingContext(query: string): boolean {
   ...
   */
  private detectConflictingFilters(query: string): string[] {
   ...
   */
  private generateIntentSuggestions(intents: IntentType[]): string[] {
   ...
   */
  private formatIntentChoice(intent: IntentType): string {
