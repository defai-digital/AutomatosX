...
import { PluginGovernance, createPluginGovernance, getGlobalGovernance, resetGlobalGovernance, VerificationTier, ReviewStatus, } from '../../governance/PluginGovernance.js';
describe('PluginGovernance', () => {
    ...
    describe('Verification Submission', () => {
        ...
        it('should reject duplicate submissions', () => {
            ...
            expect(() => governance.submitForVerification(submission)).toThrow('already has a pending verification request');
        });
    });
...
//# sourceMappingURL=PluginGovernance.test.js.map