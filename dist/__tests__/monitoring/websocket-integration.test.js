...
describe('Monitoring WebSocket Integration', () => {
    ...
    beforeEach((done) => {
        ...
        wsServer = new MonitoringWebSocketServer(WS_PORT, metrics, alerting, health, workflows);
    ...
    it('should broadcast alert when triggered', (done) => {
        ...
        client.on('open', () => {
            ...
            const ruleId = alerting.createRule('Test Alert', 'Test alert description', 'test.metric', {
                operator: 'gt',
                threshold: 5,
                windowMs: 10000,
                aggregation: 'sum',
