...
describe('SimpleQueryCache', () => {
    let cache;
    beforeEach(() => {
        cache = new SimpleQueryCache({ maxSize: 3, ttl: 1000 });
    });
    ...
    describe('TTL (Time-to-Live)', () => {
        it('should expire entries after TTL', async () => {
            const shortCache = new SimpleQueryCache({ ttl: 50 });
        ...
        it('should not expire entries before TTL', async () => {
            const longCache = new SimpleQueryCache({ ttl: 10000 });
    ...
    describe('Complex Values', () => {
        it('should handle object values', () => {
            const objCache = new SimpleQueryCache();
            const obj = { name: 'test', value: 42 };
            objCache.set('obj1', obj);
            expect(objCache.get('obj1')).toEqual(obj);
        });
        it('should handle array values', () => {
            const arrCache = new SimpleQueryCache();
            const arr = ['a', 'b', 'c'];
...
//# sourceMappingURL=SimpleQueryCache.test.js.map