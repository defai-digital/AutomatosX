 ...
 * Runbook category
 */
export var RunbookCategory;
(function (RunbookCategory) {
    RunbookCategory["INCIDENT_RESPONSE"] = "incident_response";
    RunbookCategory["MAINTENANCE"] = "maintenance";
    RunbookCategory["DEPLOYMENT"] = "deployment";
    RunbookCategory["MONITORING"] = "monitoring";
    RunbookCategory["BACKUP_RESTORE"] = "backup_restore";
})(RunbookCategory || (RunbookCategory = {}));
/**
...
export class OperationsRunbook extends EventEmitter {
     ...
     */
    getRunbooksByCategory(category) {
     ...
     * Start execution
     */
    startExecution(runbookId, executedBy) {
     ...
     */
    getExecutionsForRunbook(runbookId) {
    ...
    searchRunbooks(query) {
        ...
        return Array.from(this.runbooks.values()).filter((r) => r.title.toLowerCase().includes(lowerQuery) ||
 ...
 */
export function createOperationsRunbook() {
    return new OperationsRunbook();
}
/**
 * Global runbook instance
 */
let globalRunbook = null;
/**
 * Get global runbook
 */
export function getGlobalRunbook() {
    if (!globalRunbook) {
 ...
 */
export function resetGlobalRunbook() {
    globalRunbook = null;
}
//# sourceMappingURL=OperationsRunbook.js.map