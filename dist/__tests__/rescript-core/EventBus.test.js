...
describe('EventBus - Event Creation', () => {
    it('should create event with minimal parameters', () => {
        const event = EventBus.createEvent('test.event', JSON.parse('{"data": "test"}'), undefined, undefined, undefined, undefined);
    ...
    it('should create event with all parameters', () => {
        ...
        const event = EventBus.createEvent('test.event', JSON.parse('{"data": "test"}'), 'source-system', metadata, 5, undefined);
        expect(event.eventType).toBe('test.event');
