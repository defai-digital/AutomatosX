...
import { combineSearchResults, getSearchResultStats, } from '../../bridge/HybridSearchBridge.js';
import { resetFeatureFlags, applyRolloutPreset, } from '../../bridge/ReScriptFeatureFlags.js';
describe('HybridSearchBridge', () => {
    // Test data
    const createMessage = (id, role = 'user') => ({
        id,
    ...
    const createVectorResult = (messageId, distance) => ({
        messageId,
        distance,
    ...
    describe('Feature Flag A/B Testing', () => {
        ...
        it('should assign users deterministically', () => {
            ...
            const result1 = combineSearchResults([createMessage('msg-1')], [], undefined, userId);
            const result2 = combineSearchResults([createMessage('msg-1')], [], undefined, userId);
            const result3 = combineSearchResults([createMessage('msg-1')], [], undefined, userId);
    ...
    describe('Performance', () => {
        ...
        it('should handle large result sets efficiently', () => {
            ...
            const vectorResults = Array.from({ length: 1000 }, (_, i) => createVectorResult(`msg-vec-${i}`, Math.random()));
...
//# sourceMappingURL=HybridSearchBridge.test.js.map