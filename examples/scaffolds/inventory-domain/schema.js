...
}).refine((inv) => inv.availableQuantity === inv.totalQuantity - inv.reservedQuantity - inv.onHoldQuantity, { message: 'INV-INV-005: Available must equal total minus reserved minus on_hold' });
/**
