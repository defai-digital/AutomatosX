...
import { StatusSchema, type Status } from '../schemas/StatusSchema.js'
 ...
 */
async function checkMemoryHealth(logger: StreamingLogger): Promise<any> {
 ...
 */
async function checkProvidersHealth(logger: StreamingLogger): Promise<any> {
  await new Promise(resolve => setTimeout(resolve, 50))
 ...
 */
async function checkAgentsHealth(logger: StreamingLogger): Promise<any> {
  await new Promise(resolve => setTimeout(resolve, 50))
 ...
 */
async function checkCacheHealth(logger: StreamingLogger): Promise<any> {
  await new Promise(resolve => setTimeout(resolve, 50))
 ...
 */
async function checkFilesystemHealth(logger: StreamingLogger): Promise<any> {
  await new Promise(resolve => setTimeout(resolve, 50))
 ...
 */
function printHealthStatus(status: any, verbose: boolean, showMetrics: boolean): void {
  ...
  Object.entries(status.checks).forEach(([name, check]: [string, any]) => {
