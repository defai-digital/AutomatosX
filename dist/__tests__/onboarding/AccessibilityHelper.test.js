...
describe('AccessibilityHelper', () => {
    ...
    describe('Accessibility Preferences', () => {
        let originalHighContrast;
        let originalReducedMotion;
    ...
    describe('Accessible Help', () => {
        it('should create accessible command help', () => {
            const help = AccessibilityHelper.createAccessibleHelp('ax find', 'Search for code', {
...
//# sourceMappingURL=AccessibilityHelper.test.js.map