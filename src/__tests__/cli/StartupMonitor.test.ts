...
describe('StartupMonitor', () => {
  ...
  describe('Recommendations', () => {
    ...
    it('should recommend on slow phase', async () => {
      ...
      const slowPhaseRec = report.recommendations.find((r) =>
        r.includes('slow-init')
      )
    ...
    it('should not recommend when within thresholds', async () => {
      ...
      const performanceRecs = report.recommendations.filter(
        (r) => r.includes('Startup time') || r.includes('is slow')
      )
