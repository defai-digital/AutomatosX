...
export declare const makeStateMachine: (_1: string, _2: string) => StateMachineV2_Machine_t;
export declare const transitionStateMachine: (_1: StateMachineV2_Machine_t, _2: string, _3: string) => {
    TAG: "Ok";
    _0: StateMachineV2_Machine_t;
} | {
    TAG: "Error";
    _0: string;
};
export declare const getCurrentState: (_1: StateMachineV2_Machine_t) => string;
export declare const canTransition: (_1: StateMachineV2_Machine_t, _2: string, _3: string) => boolean;
export declare const setContextData: (_1: StateMachineV2_Machine_t, _2: string, _3: string) => StateMachineV2_Machine_t;
export declare const getContextData: (_1: StateMachineV2_Machine_t, _2: string) => (undefined | string);
export declare const createCheckpoint: (_1: StateMachineV2_Machine_t) => StateMachineV2_Machine_checkpoint;
export declare const restoreFromCheckpoint: (_1: StateMachineV2_Machine_t, _2: StateMachineV2_Machine_checkpoint) => StateMachineV2_Machine_t;
