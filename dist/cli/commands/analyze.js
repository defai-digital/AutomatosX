...
// ACTION HANDLER
// ============================================================================
async function analyzeAction(targetPath, options) {
    try {
...
// FILE ANALYSIS
// ============================================================================
async function analyzeFile(service, filePath, options, threshold) {
...
// PROJECT ANALYSIS
// ============================================================================
async function analyzeProject(service, projectPath, options, threshold) {
...
// DISPLAY HELPERS
// ============================================================================
function displayFileSummary(report, threshold) {
...
function displayProjectSummary(projectReport, filteredReports, threshold, topN) {
...
function displayTopProblematicFiles(reports, threshold) {
    console.log(chalk.bold.underline(`\nTop Problematic Files:\n`));
...
// ============================================================================
async function exportReport(projectReport, filteredReports, options) {
    const exportService = new ExportService();
    // Convert project report to export format
    const exportReport = convertToExportFormat(projectReport, filteredReports);
...
function convertToExportFormat(projectReport, filteredReports) {
    const metrics = projectReport.aggregateMetrics;
    return {
        summary: {
        ...
        files: filteredReports.map((report) => ({
        ...
        codeSmells: filteredReports.flatMap((report) => (report.codeSmells || []).map((smell) => ({
