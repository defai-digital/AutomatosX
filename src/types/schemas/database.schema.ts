...
export function validateFileUpdate(data: unknown): FileUpdate {
...
export function validateSymbolRecord(data: unknown): SymbolRecord {
...
export function validateChunkRecord(data: unknown): ChunkRecord {
  return ChunkRecordSchema.parse(data);
}

// Call DAO Helpers
export function validateCallInput(data: unknown): CallInput {
  return CallInputSchema.parse(data);
}

export function validateCallRecord(data: unknown): CallRecord {
  return CallRecordSchema.parse(data);
}

// Import DAO Helpers
export function validateImportInput(data: unknown): ImportInput {
  return ImportInputSchema.parse(data);
}

export function validateImportRecord(data: unknown): ImportRecord {
...
export function safeValidateSymbolInput(data: unknown) {
  return SymbolInputSchema.safeParse(data);
}

export function safeValidateChunkInput(data: unknown) {
...
export function isSymbolInput(value: unknown): value is SymbolInput {
  return SymbolInputSchema.safeParse(value).success;
}

export function isChunkInput(value: unknown): value is ChunkInput {
 ...
 * @returns Object with validated inputs and errors
 */
export function validateChunkInputBatch(data: unknown[]): {
  validated: ChunkInput[];
  errors: Array<{ index: number; error: z.ZodError }>;
} {
  const validated: ChunkInput[] = [];
  const errors: Array<{ index: number; error: z.ZodError }> = [];
