 ...
 */
export function validateSymbolKind(data) {
 ...
 * @throws {z.ZodError} If validation fails
 */
export function validateParseResult(data) {
 ...
 * @throws {z.ZodError} If validation fails
 */
export function validateParseResultWithErrors(data) {
 ...
 * @throws {z.ZodError} If validation fails
 */
export function validateLanguageDetection(data) {
 ...
 */
export function safeValidateSymbolKind(data) {
 ...
 * @returns SafeParseResult with success flag and data/error
 */
export function safeValidateSymbol(data) {
 ...
 * @returns SafeParseResult with success flag and data/error
 */
export function safeValidateParseResult(data) {
 ...
 */
export function isSymbolKind(value) {
 ...
 */
export function isParseResult(value) {
 ...
 */
export function getAllSymbolKinds() {
 ...
 */
export function isValidSymbolKind(kind) {
    return SymbolKindSchema.safeParse(kind).success;
}
//# sourceMappingURL=parser.schema.js.map