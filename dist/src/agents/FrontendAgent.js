...
export class FrontendAgent extends AgentBase {
    constructor() {
        super({
            ...
            description: 'Expert in frontend development, React/Next.js, UI/UX, state management, and modern frontend frameworks. Specializes in building responsive, accessible user interfaces.',
            capabilities: [
                {
    ...
    async executeTask(task, context, options) {
        ...
        try {
            const relevantCode = await context.codeIntelligence.searchCode(task.description + ' component react');
    ...
    buildFrontendPrompt(task, context, codeContext, memoryContext) {
