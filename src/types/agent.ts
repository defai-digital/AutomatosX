...
export interface AgentProfile {
  ...
  // v11.5.0+ Claude Code integration override (optional)
  // Users can add a `claude_code:` section to their agent YAML to override
  // defaults used when generating .claude/agents/<name>.md subagent files.
  claude_code?: import('./agent-claude-code.js').AgentClaudeCodeConfig;
