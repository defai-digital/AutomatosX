 ...
 */
import { uriToFilePath, getWordAtPosition, getIdentifierAtPosition, getNodeSignature, getNodeDocstring, createHoverMarkdown, formatSignature, } from '../utils/lsp-utils.js';
/**
 * Hover Provider
 */
export class HoverProvider {
     ...
     */
    async provideHover(uri, position) {
        try {
     ...
     */
    getHoverFromAST(uri, position, symbolName, content) {
        const tree = this.documentManager.getDocumentTree(uri);
        if (!tree) {
            return null;
        }
     ...
     */
    async getHoverFromDatabase(symbolName, filePath) {
     ...
     */
    provideBuiltInHover(symbolName) {
     ...
     */
    async provideHoverWithType(uri, position) {
