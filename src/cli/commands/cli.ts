...
export async function launchCLI(): Promise<void> {
  try {
    ...
    console.error(chalk.red('\n❌ Failed to start Interactive CLI:'), (error as Error).message);
    process.exit(1);
  }
}
 ...
 */
function registerRefinementCommands(
  registry: SlashCommandRegistry,
  learningSystem: IntentLearningSystem,
  iterateHandler: IterateModeHandler
): void {
