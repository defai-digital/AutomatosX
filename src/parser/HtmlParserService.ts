...
export class HtmlParserService extends BaseLanguageParser {
   ...
   */
  private extractStyleElement(node: Parser.SyntaxNode): Symbol | null {
   ...
   */
  private extractSelfClosingTag(node: Parser.SyntaxNode): Symbol | null {
    // Get tag name - it's a child node
   ...
   */
  private getAttributeValue(tagNode: Parser.SyntaxNode, attributeName: string): string | null {
