...
import { QuotaExceededError } from '../types/security.types.js';
...
export class QuotaService extends EventEmitter {
    ...
    async incrementQuota(tenantId, quotaType, amount = 1) {
    ...
    async decrementQuota(tenantId, quotaType, amount = 1) {
        this.db.prepare(`
      UPDATE tenant_quotas
