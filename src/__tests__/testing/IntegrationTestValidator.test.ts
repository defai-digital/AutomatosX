...
import {
  ...
  createIntegrationTestValidator,
  getGlobalIntegrationTestValidator,
  resetGlobalIntegrationTestValidator,
  type TestScenario,
} from '../../testing/IntegrationTestValidator.js'

describe('IntegrationTestValidator', () => {
  let validator: IntegrationTestValidator
  ...
  describe('Scenario Execution', () => {
    ...
    it('should throw error for non-existent scenario', async () => {
      await expect(validator.runScenario('non-existent')).rejects.toThrow(
        'Scenario not found'
      )
    })
  ...
  describe('Scenario Queries', () => {
    ...
    it('should filter operations scenarios', () => {
      ...
      expect(operationsScenarios.some((s) => s.id === 'operations-automation-flow')).toBe(
        true
      )
    })
    ...
    it('should filter migration scenarios', () => {
      ...
      expect(migrationScenarios.some((s) => s.id === 'migration-onboarding-flow')).toBe(
        true
      )
    })
