...
export class QueryPresets {
     ...
     */
    static recentMemories(limit = 10) {
     ...
     */
    static searchAgentDateRange(query, agent, from, to, limit = 10) {
        return new MemoryQueryBuilder()
            .search(query)
            .filterByAgent(agent)
            .filterByDateRange(from, to)
...
//# sourceMappingURL=MemoryQueryBuilder.js.map