...
AutomatosX configuration is stored in `automatosx.config.json` at your project root. This guide covers all configuration options, provider setup, and common scenarios.
...
The minimal `automatosx.config.json`:
