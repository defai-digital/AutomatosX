...
import { PluginTemplateGenerator, createTemplateGenerator, getGlobalGenerator, resetGlobalGenerator, PluginCategory, PluginLanguage, } from '../../plugins/PluginTemplateGenerator.js';
describe('PluginTemplateGenerator', () => {
    ...
    describe('Template Retrieval', () => {
        it('should get agent TypeScript template', () => {
            const templates = generator.getTemplateFiles(PluginCategory.AGENT, PluginLanguage.TYPESCRIPT);
            expect(templates.length).toBeGreaterThan(0);
            expect(templates[0].path).toBe('src/index.ts');
        });
        it('should get tool TypeScript template', () => {
            const templates = generator.getTemplateFiles(PluginCategory.TOOL, PluginLanguage.TYPESCRIPT);
            expect(templates.length).toBeGreaterThan(0);
            expect(templates[0].path).toBe('src/index.ts');
        });
        it('should get workflow TypeScript template', () => {
            const templates = generator.getTemplateFiles(PluginCategory.WORKFLOW, PluginLanguage.TYPESCRIPT);
            expect(templates.length).toBeGreaterThan(0);
            expect(templates[0].path).toBe('src/index.ts');
        });
        it('should get hybrid TypeScript template', () => {
            const templates = generator.getTemplateFiles(PluginCategory.HYBRID, PluginLanguage.TYPESCRIPT);
            expect(templates.length).toBeGreaterThan(0);
            expect(templates[0].path).toBe('src/index.ts');
        });
    ...
    describe('Template Registration', () => {
        it('should register custom template', () => {
            ...
            generator.registerTemplate(PluginCategory.AGENT, PluginLanguage.PYTHON, customTemplate);
...
//# sourceMappingURL=PluginTemplateGenerator.test.js.map