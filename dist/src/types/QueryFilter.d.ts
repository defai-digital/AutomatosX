 ...
 */
export type SymbolKind = 'function' | 'class' | 'method' | 'interface' | 'type' | 'variable' | 'constant' | 'enum' | 'struct' | 'trait' | 'impl' | 'module';
/**
 ...
 */
export declare function createEmptyFilters(): QueryFilters;
/**
 * Checks if filters are empty (no filters applied)
 */
export declare function isEmptyFilters(filters: QueryFilters): boolean;
