...
import type { MCPServerState } from '@defai.digital/contracts';
import { MCPEcosystemErrorCodes } from '@defai.digital/contracts';

describe('MCP Ecosystem Domain', () => {
  let serverStorage: InMemoryServerRegistry;
  let toolRegistry: InMemoryToolRegistry;
  let resourceRegistry: InMemoryResourceRegistry;
  let clientFactory: StubMCPClientFactory;
