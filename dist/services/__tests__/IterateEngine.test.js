...
class MockWorkflowEngine {
    ...
    failureCount = 0;
    maxFailures = 0;
    returnCostOnFailure = false;
    setFailurePattern(failCount) {
        this.maxFailures = failCount;
        this.failureCount = 0;
        this.returnCostOnFailure = false;
    }
    setReturnCostOnFailure(value) {
        this.returnCostOnFailure = value;
    }
    async executeWorkflow(path, config) {
        this.failureCount++;
...
describe('IterateEngine', () => {
    ...
    beforeEach(() => {
        ...
        engine = new IterateEngine(mockWorkflowEngine, mockCheckpointService, 'auto');
    });
    ...
    describe('Timeout Limit', () => {
        it('should stop when timeout is exceeded', async () => {
            ...
            mockWorkflowEngine.executeWorkflow = async (path, config) => {
...
//# sourceMappingURL=IterateEngine.test.js.map