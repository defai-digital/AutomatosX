...
export class SafetyEvaluator {
     ...
     */
    async evaluate(strategy, safetyLevel, iterationHistory) {
        ...
        const riskScore = this.calculateRiskScore(iterationHistory, totalCost, totalDuration, thresholds);
     ...
     */
    checkCostLimit(totalCost, thresholds, warnings) {
     ...
     */
    checkDurationLimit(totalDuration, thresholds, warnings) {
     ...
     */
    checkFailurePattern(iterationHistory, thresholds, warnings) {
        const consecutiveFailures = this.countConsecutiveFailures(iterationHistory);
     ...
     */
    calculateRiskScore(iterationHistory, totalCost, totalDuration, thresholds) {
        let risk = 0.0;
        // Cost risk (0-0.3)
     ...
     */
    calculateFailureRate(iterationHistory) {
     ...
     */
    countConsecutiveFailures(iterationHistory) {
        let count = 0;
