...
export class FixtureBuilder {
   ...
   */
  private buildWorkflowFixture(workflow: WorkflowDefinition): FixtureFile {
    const content = `/**
 * Workflow Fixture
...
`;
   ...
   * Build steps fixture
   */
  private buildStepsFixture(steps: TestableStep[]): FixtureFile {
    const content = `/**
 * Steps Fixtures
 * Generated by AutomatosX v8.0.0
 */
...
`;
   ...
   */
  private buildErrorFixtures(): FixtureFile {
    const content = `/**
 * Error Fixtures
 * Generated by AutomatosX v8.0.0
 */
...
`;
   ...
   */
  private buildEdgeCaseFixtures(): FixtureFile {
    const content = `/**
 * Edge Case Fixtures
 * Generated by AutomatosX v8.0.0
 */
...
`;
   ...
   */
  private estimateTotalDuration(steps: WorkflowStep[]): number {
   ...
   * Estimate total cost
   */
  private estimateTotalCost(steps: WorkflowStep[]): number {
