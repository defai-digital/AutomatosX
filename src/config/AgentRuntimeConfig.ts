...
// REFACTORING #36: Temperature profiles for different agent types
...
// REFACTORING #36: Token limits for agent responses
...
export interface AgentRuntimeConfig {
  ...
  temperatureProfiles: TemperatureProfiles;  // REFACTORING #36
  tokenLimits: TokenLimits;  // REFACTORING #36
  team: TeamConfig;
...
export function loadAgentRuntimeConfig(): AgentRuntimeConfig {
  ...
  try {
    ...
    const config = YAML.parse(yamlContent) as AgentRuntimeConfig;
 ...
 */
function getDefaultAgentRuntimeConfig(): AgentRuntimeConfig {
  return {
    version: '1.0',
    execution: {
