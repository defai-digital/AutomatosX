...
export class TaskRouter {
     ...
     */
    calculateConfidence(description, intent, mentionedAgent) {
        let confidence = 0;
     ...
     */
    getSuggestedAgents(task, limit = 3) {
        const suggestions = [];
        const parsed = this.parseTask(task.description);
