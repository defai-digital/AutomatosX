...
import { MarketplaceAnalyticsAPI, createMarketplaceAnalyticsAPI, getGlobalAPI, resetGlobalAPI, ExportFormat, } from '../../marketplace/MarketplaceAnalyticsAPI.js';
...
describe('MarketplaceAnalyticsAPI', () => {
    ...
    describe('Export Functionality', () => {
        ...
        it('should export plugin analytics as CSV', async () => {
            ...
            expect(typeof exported).toBe('string');
            expect(exported.includes('Plugin Analytics Report')).toBe(true);
        });
        it('should throw error for non-existent plugin export', async () => {
            await expect(analyticsAPI.exportPluginAnalytics('non-existent', ExportFormat.JSON)).rejects.toThrow('No analytics found');
        });
        ...
        it('should export community overview as CSV', async () => {
            ...
            expect(typeof exported).toBe('string');
            expect(exported.includes('Community Overview Report')).toBe(true);
        });
    });
...
//# sourceMappingURL=MarketplaceAnalyticsAPI.test.js.map