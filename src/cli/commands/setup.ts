...
export const setupCommand: CommandModule<Record<string, unknown>, SetupOptions> = {
  ...
  describe: 'Interactive setup wizard for provider configuration',
  ...
  builder: (yargs) => {
    return yargs
      ...
      .example('$0 setup', 'Configure OpenAI integration mode')
      .example('$0 setup openai', 'Configure OpenAI integration mode')
      .example('$0 setup --verbose', 'Detailed configuration wizard');
  },
