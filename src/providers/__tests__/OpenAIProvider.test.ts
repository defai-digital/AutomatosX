...
describe('OpenAIProvider', () => {
  ...
  describe('request', () => {
    ...
    it('should throw ProviderAuthError on 401', async () => {
      const apiError = new (OpenAI as any).APIError(401, 'Invalid API key')
    ...
    it('should throw ProviderTimeoutError on 408', async () => {
      const apiError = new (OpenAI as any).APIError(408, 'Request timeout')
      mockCreate.mockRejectedValueOnce(apiError)
    ...
    it('should throw ProviderNetworkError on 500', async () => {
      const apiError = new (OpenAI as any).APIError(500, 'Internal server error')
      mockCreate.mockRejectedValueOnce(apiError)
    ...
    it('should retry on retryable errors', async () => {
      const apiError = new (OpenAI as any).APIError(503, 'Service unavailable')
      const mockResponse = {
        id: 'chatcmpl-123',
        model: OPENAI_MODELS['gpt-4o'],
        choices: [
  ...
  describe('streamRequest', () => {
    ...
    it('should handle streaming errors', async () => {
      const apiError = new (OpenAI as any).APIError(500, 'Streaming error')
      mockCreate.mockRejectedValueOnce(apiError)
  ...
  describe('healthCheck', () => {
    ...
    it('should return unhealthy status on error', async () => {
      const apiError = new (OpenAI as any).APIError(500, 'Service down')
      mockCreate.mockRejectedValueOnce(apiError)
