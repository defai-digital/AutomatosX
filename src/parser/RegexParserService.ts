...
export class RegexParserService extends BaseLanguageParser {
  ...
  readonly extensions = ['.regex', '.re'];

  constructor() {
    super(Regex as Parser.Language);
  }
   ...
   */
  private extractNamedGroup(node: Parser.SyntaxNode): Symbol | null {
   ...
   * Extract group name
   */
  private extractGroupName(node: Parser.SyntaxNode): Symbol | null {
