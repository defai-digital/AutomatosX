...
import { LazyLoader, createLazyLoader, getGlobalLoader, resetGlobalLoader, } from '../../cli/LazyLoader.js';
...
describe('LazyLoader', () => {
    ...
    describe('Loading', () => {
        it('should throw when loading unregistered module', async () => {
            await expect(loader.load('unregistered')).rejects.toThrow('Module "unregistered" not registered');
        });
    ...
    describe('Module Access', () => {
        ...
        it('should throw when getting unloaded module', () => {
            loader.register('test', { path: './test.js' });
            expect(() => loader.get('test')).toThrow('Module "test" not loaded. Call load() first.');
        });
    ...
    describe('Statistics', () => {
        ...
        it('should track slowest module', async () => {
            ...
            writeFileSync(slow, 'export const s = 1; await new Promise(r => setTimeout(r, 50));');
...
//# sourceMappingURL=LazyLoader.test.js.map