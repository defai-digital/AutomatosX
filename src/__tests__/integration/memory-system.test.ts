...
describe('Memory System Integration', () => {
  ...
  describe('ReScript State Machine', () => {
    ...
    it('should transition from idle to active', () => {
      ...
      const result = MemoryStateMachine.transition(
        machine,
        'create_conversation',
    ...
    it('should validate transition capabilities', () => {
      ...
      expect(MemoryStateMachine.canTransition(machine, 'create_conversation', 'active')).toBe(
        true
      );
  ...
  describe('End-to-End Memory Workflow', () => {
    ...
    it('should complete a full conversation lifecycle', () => {
      ...
      const result1 = MemoryStateMachine.transition(
        machine,
        'create_conversation',
        JSON.parse(createEvent),
        'active'
      );
      ...
      const result2 = MemoryStateMachine.transition(
        machine,
        'search_messages',
        JSON.parse(searchEvent),
        'searching'
      );
      ...
      const result3 = MemoryStateMachine.transition(
        machine,
        'archive_conversation',
        JSON.parse(archiveEvent),
        'archived'
      );
