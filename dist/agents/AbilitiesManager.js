...
export class AbilitiesManager {
     ...
     */
    async loadCoreAbilities(profile) {
        ...
        const abilities = results.filter((content) => content !== null);
     ...
     */
    async loadTaskAbilities(task, profile) {
     ...
     */
    async loadAllAbilities(task, profile) {
    ...
    async loadAbility(abilityName) {
        ...
        const abilityPath = join(this.projectRoot, AUTOMATOSX_DIRS.ABILITIES, `${abilityName}.md`);
     ...
     */
    formatAbilitiesForPrompt(abilities) {
        if (abilities.length === 0) {
            return '';
        }
...
//# sourceMappingURL=AbilitiesManager.js.map