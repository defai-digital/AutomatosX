...
export class FailureAnalyzer {
     ...
     */
    async analyze(error, progress, iterationHistory) {
        // Classify error type
        ...
        const recommendations = this.generateRecommendations(errorType, isTransient, failurePattern, iterationHistory);
     ...
     */
    isTransientError(errorType, error) {
     ...
     */
    isPermanentError(errorType, error) {
     ...
     */
    assessSeverity(errorType, progress, iterationHistory) {
     ...
     */
    detectPattern(errorType, iterationHistory) {
     ...
     */
    generateRecommendations(errorType, isTransient, failurePattern, iterationHistory) {
     ...
     */
    calculateConfidence(errorType, iterationHistory) {
     ...
     */
    extractFailedStep(error, progress) {
