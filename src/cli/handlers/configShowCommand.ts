...
import { ConfigShowSchema, type ConfigShow } from '../schemas/ConfigShowSchema.js'
 ...
 */
async function mockLoadConfig(logger: StreamingLogger): Promise<any> {
 ...
 */
function printYamlConfig(config: any, indent: number = 0): void {
 ...
 */
function printTextConfig(config: any, showDefaults: boolean, showSources: boolean): void {
 ...
 */
function printConfigTree(obj: any, level: number): void {
