...
export function createRateLimitCommand() {
    ...
    command
        ...
        const limiter = new ProviderRateLimiter();
        try {
            await limiter.setUserQuota(options.user, options.limit, options.window, options.burst, options.expires);
 ...
 */
async function showUserStatus(limiter, userId, verbose) {
 ...
 */
async function showProviderStatus(limiter, provider, verbose) {
 ...
 */
async function showIpStatus(limiter, ip, verbose) {
 ...
 */
async function showGlobalStatus(limiter, verbose) {
 ...
 */
async function showAllStatus(limiter, verbose) {
    console.log(chalk.bold('\nRate Limit Status:\n'));
    // Global
