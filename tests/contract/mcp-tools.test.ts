...
import {
  ...
  PolicySummarySchema,
  GuardToolErrorCode,
  validateGuardCheckInput,
  validateGuardListInput,
  validateGuardApplyInput,
  safeValidateGuardCheckInput,
  type GuardCheckInput,
  type GuardCheckOutput,
  type GuardListInput,
  type GuardListOutput,
  type GuardApplyInput,
  type GuardApplyOutput,
  ...
  AgentToolErrorCode,
  validateAgentListInput,
  validateAgentRunInput,
  validateAgentGetInput,
  validateAgentRegisterInput,
  validateAgentRemoveInput,
  safeValidateAgentListInput,
  safeValidateAgentRunInput,
  safeValidateAgentGetInput,
  type AgentListInput,
  ...
  SessionParticipantSummarySchema,
  SessionToolErrorCode,
  validateSessionCreateInput,
  validateSessionStatusInput,
  validateSessionCompleteInput,
  validateSessionListInput,
  validateSessionJoinInput,
  validateSessionLeaveInput,
  validateSessionFailInput,
  safeValidateSessionCreateInput,
  ...
  validateMemoryRetrieveInput,
  validateMemorySearchInput,
  validateMemoryListInput,
  validateMemoryDeleteInput,
  ...
  describe('guard_check', () => {
    describe('input validation', () => {
      ...
      it('should use validateGuardCheckInput for throwing validation', () => {
        expect(() =>
          validateGuardCheckInput({ policyId: 'INVALID', changedPaths: [] })
        ).toThrow();
      });
  ...
  describe('guard_list', () => {
    describe('input validation', () => {
      ...
      it('should validate custom limit', () => {
        const input: GuardListInput = { limit: 50 };
...
describe('MCP Tool Contracts - Agent', () => {
  ...
  describe('agent_get', () => {
    describe('input validation', () => {
      it('should validate valid agent_get input', () => {
        const input: AgentGetInput = { agentId: 'code-reviewer' };
  ...
  describe('error codes', () => {
    it('should have all expected agent error codes', () => {
      ...
      expect(AgentToolErrorCode.AGENT_DELEGATION_DEPTH_EXCEEDED).toBe(
...
describe('MCP Tool Contracts - Session', () => {
  describe('session_create', () => {
    ...
    describe('output validation', () => {
      it('should validate valid session_create output', () => {
        const output: SessionCreateOutput = {
          sessionId: randomUUID(),
          initiator: 'user-agent',
          task: 'Test task',
          status: 'active',
  ...
  describe('session_status', () => {
    describe('input validation', () => {
      it('should validate valid session_status input', () => {
        const input: SessionStatusInput = { sessionId: randomUUID() };
  ...
  describe('error codes', () => {
    it('should have all expected session error codes', () => {
      ...
      expect(SessionToolErrorCode.SESSION_AGENT_NOT_PARTICIPANT).toBe(
        'SESSION_AGENT_NOT_PARTICIPANT'
      );
      expect(SessionToolErrorCode.SESSION_INITIATOR_CANNOT_LEAVE).toBe(
        'SESSION_INITIATOR_CANNOT_LEAVE'
      );
    });
  });
  ...
  describe('memory_store', () => {
    ...
    describe('output validation', () => {
      it('should validate valid memory_store output', () => {
        const output: MemoryStoreOutput = {
          success: true,
          key: 'test-key',
          namespace: 'default',
  ...
  describe('memory_retrieve', () => {
    describe('input validation', () => {
      it('should validate valid memory_retrieve input', () => {
        const input: MemoryRetrieveInput = {
          key: 'my-key',
          namespace: 'app',
        };
    ...
    describe('output validation', () => {
      it('should validate found memory_retrieve output', () => {
        const output: MemoryRetrieveOutput = {
          found: true,
          key: 'test',
          namespace: 'default',
          value: { data: 'test' },
