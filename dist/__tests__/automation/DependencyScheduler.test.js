...
import { DependencyScheduler, createDependencyScheduler, getGlobalScheduler, resetGlobalScheduler, ScheduleFrequency, } from '../../automation/DependencyScheduler.js';
...
describe('DependencyScheduler', () => {
    ...
    describe('Schedule Creation', () => {
        it('should create schedule', () => {
            ...
            const schedule = scheduler.createSchedule('/test/project', ScheduleFrequency.DAILY, 'patch-only');
    ...
    describe('Schedule Execution', () => {
        it('should run schedule', async () => {
            ...
            const schedule = scheduler.createSchedule('/test/project', ScheduleFrequency.DAILY);
...
//# sourceMappingURL=DependencyScheduler.test.js.map