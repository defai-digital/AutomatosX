...
export class REPLSession {
    ...
    constructor(db, providerRouter, agentRegistry, commandRegistry, options = {}) {
        this.db = db;
...
`);
    ...
    updateHistorySearch() {
        ...
        this.historySearchMatches = history.filter((line) => line.toLowerCase().includes(this.historySearchQuery.toLowerCase()));
        // Reset index
        this.historySearchIndex = 0;
        // Update prompt
        this.updateHistorySearchPrompt();
...
//# sourceMappingURL=REPLSession.js.map